...
| --- | --- | --- | --- | --- |
| Softmax | fp32，行主序、逐行归一化 | 进行中（v0/v1/v2/v3/v4/v5 与 online-v0/v1/v2 完成） | 规划中 | `operators/softmax` |
...
├── operators/
│   ├── softmax/                # Softmax：CUDA → Triton（src/ 已创建，v0/v1/v2/v3/v4/v5 与 online-v0/v1/v2 完成）
...
- [x] 仓库骨架与文档
- [ ] Softmax：CUDA 核心版本（v0/v1/v2/v3/v4/v5 与 online-v0/v1/v2 完成 → Triton 对照）
